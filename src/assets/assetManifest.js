...
export const ASSET_MANIFEST = [
    ...
    { ...An('rooster',  'Horoz',         { w: 1, d: 1 }, 0.70), builder: A.rooster,  farmType: 'animal', wasteRate: 2,
      tip: 'Horoz varlığı tavuk yumurta verimliliğini artırır.' },
    { ...An('chick',    'Civciv',         { w: 1, d: 1 }, 0.50), builder: A.chick,    farmType: 'animal', wasteRate: 1,
      tip: 'Civcivler büyüdükçe çiftliğin tavuk sayısını artırır.' },
    { ...An('duck',     'Ördek',          { w: 1, d: 1 }, 0.75), builder: A.duck,     farmType: 'animal', wasteRate: 2,
      tip: 'Ördekler hem yumurta hem et hem de böcek kontrolü sağlar.' },
    { ...An('duckling', 'Ördek Yavrusu',  { w: 1, d: 1 }, 0.45), builder: A.duckling, farmType: 'animal', wasteRate: 1,
      tip: 'Ördek yavruları su kenarında doğal ekosisteme katkı sağlar.' },
    { ...An('goat',     'Keçi',           { w: 1, d: 1 }, 0.80), builder: A.goat,     farmType: 'animal', wasteRate: 3,
      tip: 'Keçi sütü, eti ve deri üretiminin yanı sıra ot kontrolü sağlar.' },
    { ...An('lamb',     'Kuzu',           { w: 1, d: 1 }, 0.60), builder: A.lamb,     farmType: 'animal', wasteRate: 2,
      tip: 'Kuzu koyun sürüsünün sürdürülebilirliğini sağlar.' },
    { ...An('horse',    'At',             { w: 1, d: 1 }, 0.95), builder: A.horse,    farmType: 'animal', wasteRate: 4,
      tip: 'At tarımda çekiş gücü sağlar; yakıtsız tarımın sembolüdür.' },
